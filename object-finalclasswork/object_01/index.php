...
<head>
	...
	<script src="htteps://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-wEmeIV1mKuiNpC+IOBjI7aAzPcEZeedi5yW5f2yOq55WWLwNGmvvx4Um1vskeMj0" crossorigin="anonymous">

	<style>
		body{
			background: rgb(230,200,23);
			background: linear-gradient(45deg, rgba(230,200,23,0.38139005602240894) 35%, rgba(224,149,19,0.927608543417367) 100%);
			font-family: '微軟正黑體' ;
			font-size: 20px
		}
		.cent > img{
...
<body>
 <div class="container" style="height:100wh;">
		...
		<div id="ms">
			<div id="lf" style="float:left;">
				...
				<div class="dbor" style="margin:3px; width:95%; height:20%; line-height:100px;">
					...
					<span  class="badge bg-warning text-dark" style="width: 200px;">
						進站人數:				
			...
			<div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
				...
				<div style="width:89%; height:480px;" class="dbor">
					...
					<div class='cent' onclick='pp(1)' style="margin:5px 0" id>
